...
public class NFC : MonoBehaviour {
	...
	void Start() {
		tag_output_text.text = "Scan for login...";
				...
				try {
					...
					if (sAction == "android.nfc.action.NDEF_DISCOVERED") {
						...
						if (mNdefMessage != null) {
							...
							if (text == "BN+XMs9PgA==")
							{
								tag_output_text.text = "Velkommen Marinus, du er nu logget ind";
								tagID = text;
								
							} else if (text == "W/ZMlQ==")
							{
								tag_output_text.text = "Velkommen Mia, du er nu logget ind";
								tagID = text;
							...
							{
								tag_output_text.text += "This is your tag text: " + text + " du har ikke en konto";
								tagID = text;
							}

							
							Destroy (GetComponent("SpriteRenderer")); //Destroy Box when NFC ID is displayed
						...
						tag_output_text.text = "Scan kort for check in...";
						return;
					}
				}
				catch (Exception ex) {
